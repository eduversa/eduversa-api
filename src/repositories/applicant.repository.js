...
const AcademicInfo = require("./profile/academic_info.repository");
const { ApplicantCourseInfo } = require("./profile/course_info.repository");
const FamilyInfo = require("./profile/family_info.repository");
const PersonalInfo = require("./profile/personal_info.repository");
